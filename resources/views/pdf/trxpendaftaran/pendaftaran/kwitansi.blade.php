...
<body>
   ...
   <div class="row" style="text-align: center">
    ...
    <table id="table" style="width: 100%;;
        ...
        <tbody>
            @foreach ($data2 as $data2)
                <td style="padding-left: 40px;padding-right: 40px;border: 4px solid;width: 30%;text-align:center"><h3>LUNAS</h3></td>
                <td>
                    ...
                    <div>
                        ...
                        {{--  <hr>  --}}
                        <h5 style="margin-bottom: 60px;margin-top: -5px">
                        ...
                        <hr>
                     <h6 style="margin-top:-10px">Kepala UPPD Kandangan
                    kasi pelayanan PKB BBNKB</h6>
    ...
    <p>* Kwitansi Pembayaran Di Verifikasi Oleh Admin</p>
