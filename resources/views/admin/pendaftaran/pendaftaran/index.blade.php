...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.trxpendaftaran') }}" target="_blank" title="Unduh Dokumen (PDF)" class="btn btn-md btn-success mb-3"><i
...
@include('admin.pendaftaran.pendaftaran.form')
@endsection
...
<script src="{{asset('js/pendaftaran/admin/pendaftaran/main.js')}}"></script>
@endsection
