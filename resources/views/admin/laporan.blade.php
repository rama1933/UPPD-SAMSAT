                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('pdf.user')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                        <tr>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('pdf.trxpendaftaran')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                                </td>
                            </tr>
