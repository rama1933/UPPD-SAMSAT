            ...
            <div class="slider-hero">
                <div class="featured-carousel owl-carousel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="update ml-auto mr-auto">
                                            ...
                                            <button onclick="edit(' {{ auth()->user()->dealer_id }}')" data-toggle="modal"
                                                data-target="#modal-edit" class="btn btn-primary btn-round">Edit
                                                Profile</button>
                                            <a href="{{ route('pdf.userdetail', auth()->user()->dealer_id) }}"
                                                target="_blank" class="btn btn-success btn-round edit"> <i
                                                    class="fa fa-print">
                                                </i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="work">
                            <div class="img d-flex align-items-center justify-content-center"
                                ...
                                <div class="text" style="color: white">
                                    ...
                                    <p style="font-weight: bold;">" Terwujudnya Pelayanan Prima Demi Kepuasan Masyarakat"
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="work">
                            <div class="img d-flex align-items-center justify-content-center"
                                style="background-image: url(logo/bg3.jpg);">
                                <div class="text" style="color: white">
                                    <h2 style="text-align: center;font-weight: bold;">Misi :</h2>
                                    <p style="font-weight: bold;">1. Menyediakan pelayanan kepada masyarakat pemilik
                                        kendaraan bermotor dalam pengurusan STNK, <br>
                                        pembayaran PKB/BBNKB dan
                                        SWDKLLJ secara cepat, tepat dan benar serta berpedoman pada ketentuan yang berlaku.
                                    </p>
                                    <p style="font-weight: bold;">
                                        2. Menyajikan data sebagai bahan infomasi tentang identitas kepemilikan kendaraan
                                        bermotor, <br> nilai PKB/BBNKB dan SWDKLLJ
                                        kendaraan bermotor yang diperlukan untuk pengambilan keputusan.
                                    </p>
                                    <p style="font-weight: bold;">3. Menyelenggarakan tertib administrasi dokumen secara
                                        baik, <br> benar dan akurat dalam rangka menjamin kepastian hukum
                                        kepemilikan dan identitas data kendaraan bermotor</p>
                                    <p style="font-weight: bold;">
                                        4. Melakukan upaya peningkatan untuk layanan melalui perbaikan sarana dan prasarana,
                                        <br> sistem komputerisasi serta
                                        pengembangan SDM.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="my-5 text-center">
                    <ul class="thumbnail">
                        <li class="active img"><a href="#"><img src="{{ asset('/logo/bg.jpg') }}" alt="Image"
                                    class="img-fluid" style="opacity: 0.6">
                                <p
                                    style="z-index: 100;position: absolute;color: white;font-size: 18px;font-weight: bold;left: 440px;top: 20px;">
                                    Profile</p>
                            </a>
                        </li>
                        <li><a href="#"><img src="{{ asset('/logo/bg.jpg') }}" alt="Image" class="img-fluid"
                                    style="opacity: 0.6">
                                <p
                                    style="z-index: 100;position: absolute;color: white;font-size: 18px;font-weight: bold;left: 545px;top: 20px;">
                                    Visi
                                </p>
                            </a></li>
                        <li><a href="#"><img src="{{ asset('/logo/bg.jpg') }}" alt="Image" class="img-fluid"
                                    style="opacity: 0.6">
                                <p
                                    style="z-index: 100;position: absolute;color: white;font-size: 18px;font-weight: bold;left: 635px;top: 20px;">
                                    Misi
                                </p>
                            </a></li>
                    </ul>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img style="max-height: 600px" class="d-block w-100" src="{{ asset('/logo/slide1.jpg') }}"
                            alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img style="max-height: 600px" class="d-block w-100" src="{{ asset('/logo/slide2.jpg') }}"
                            alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img style="max-height: 600px" class="d-block w-100" src="{{ asset('/logo/slide3.jpg') }}"
                            alt="Third slide">
                    </div>
                    <div class="carousel-item">
                        <img style="max-height: 600px" class="d-block w-100" src="{{ asset('/logo/slide4.jpg') }}"
                            alt="Third slide">
                    </div>
                </div>
